...
| --- | --- | --- | --- | --- |
| Mining | `bigbangskills:mining` | quebra de blocos na tag `#bigbangskills:mining_ores` | XP por registry/tag, cap, curva, mundos, permissões | nenhum bônus de drop ainda; apenas pipeline, persistência e feedback |
