...
| `Bonus_Drops.*` | configured drop modifiers | Mining/Woodcutting/Herbalism Double Drops and Verdant Bounty are level/formula driven; Woodcutting defaults and overrides live in `skills/woodcutting-drops.properties`; Blast Mining bonus drops are configurable with rank multiplier/chance |
