...
| Blast Mining tracks delayed TNT owner metadata and WorldGuard context | Fabric/NeoForge explosion APIs expose different source/event state | Immediate player-triggered TNT is supported with ore/debris processing, illegal-drop filtering, Demolitions damage and PvP cap; delayed tracked TNT owner/region parity remains pending |
