...
* Propagação de provenance em explosão, árvores e transformações de mods; pistões transferem a marca em extensão/retração e fluidos de balde propagam/limpam a marca nos dois loaders.
...
* Provenance persistida cobre place/break de minério/log observado pelos loaders, transferência por pistão e fluxo de líquidos de balde; explosão e transformações externas continuam fora do escopo.
