...
Mining consulta a tag `#bigbangskills:mining_ores`; Woodcutting consulta `#bigbangskills:woodcutting_logs`. O XP vem da definição e pode ser ajustado por mundo. Nenhum dos dois adapters conhece o `SkillState` internamente.
