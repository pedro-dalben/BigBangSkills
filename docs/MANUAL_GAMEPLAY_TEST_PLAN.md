...
| Mining anti-exploit | Place an ore, reconnect, push and retract it with a piston, then break it; test explosion/fake-player path where enabled | Placement/piston/break screenshots and server log proving zero or expected XP after movement |
