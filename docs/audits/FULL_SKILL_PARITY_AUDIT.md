...
|---|---|---|---|---|
| Acrobatics | fall/dodge/roll | reference roll damage reduction, doubled Graceful Roll chance, fatal guard, Dodge reduction/XP and fall/roll XP split | hurt/fall callbacks | damage/fall events |
...
| Taming | tame/pet combat | tame XP, gore, claws, Fast Food, Pummel, Holy Hound, configurable tameable summon recipes with owner limits/expiry, Beast Lore, defence and teleport; Environmentally Aware preserves lethal environmental damage | entity callback/pet combat + hurt mixin | entity event/pet combat + incoming damage |
...
manual TNT owner/tracked-entity behavior, WorldGuard/region context, and several combat secondary-target
...
| Wrong formulas / cooldowns | PARTIAL | Shared formulas, Greater Impact armored-target behavior, reference 25% rank-4 Cripple cap, fishing rank/timer formulas, attack-strength-scaled Cripple/Momentum/Rupture, repair mastery, two-stage Arcane Forging rolls and capped standard ability duration are tested; ability-specific runtime cooldown smoke remains pending. |
